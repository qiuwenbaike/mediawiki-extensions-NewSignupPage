...
// Mandatory check
(function () {
	var a = ( !document.getElementById("wpOATHToken") && !document.getElementById("mw-input-retype") ) ? document.getElementById("wpLoginAttempt") || document.getElementById("wpCreateaccount") : false;
